...
1. Open Admin Settings > Security and review Key Vault-backed action secret usage.
...
- **Open Security** &mdash; Review Key Vault secret storage and reminder configuration.
