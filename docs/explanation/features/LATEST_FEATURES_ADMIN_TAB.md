...
Screenshot placeholders are named and reserved under:
- `application/single_app/static/images/features/`

Suggested filenames currently surfaced in the admin UI:
- `guided_tutorials_chat.png`
- `guided_tutorials_workspace.png`
- `background_completion_notifications.png`
...
- Expand any card to review the feature summary and suggested screenshot filename.
...
- Confirm placeholder screenshot filenames are visible before real assets are added.
