...
UI refined through version: **0.241.224**
...
- The **Popular** tab shows top-used accessible agents when usage data exists.
- Popular ranking uses agent usage counts without showing implementation-oriented run counts in the main list. Agent details show the count as **Times used**.
...
- Agent details include instructions, scope, type, model, actions, tags, and usage count.
