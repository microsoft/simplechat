...
*   **Agent Actions Are No Longer Skipped When A Workspace Is In Scope**
    ...
    *   (Ref: `build_search_augmentation_system_prompt`, `build_mixed_source_evidence_handoff`, agent actions, workspace search)
...
*   **Spreadsheets In A Workspace Are Now Actually Computed**
    ...
    *   (Ref: `should_run_tabular_evidence`, `functions_mixed_source_orchestration.py`, tabular processing, mixed-source evidence)
...
*   **A Skipped Spreadsheet Now Tells The Model What It Is Missing**
    ...
    *   (Ref: `execute_tabular_evidence_sources`, evidence envelopes, tabular citations)
