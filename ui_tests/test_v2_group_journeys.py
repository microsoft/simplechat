...
Coverage table (contract sec 4 / M8_GROUP_PARITY_MATRIX sec 8; every row names its tests):
  ...
  J11 directory to member ...... test_v2_group_directory.py::test_owner_approves_a_join_request
                                  (join request raised, owner approval, membership store updated)
  J12 conflict smoke ........... test_v2_rebase_draft_logic.mjs
                                  + test_v2_group_workflow_file_sync.py::test_a_stale_definition_save_is_refused_and_kept
