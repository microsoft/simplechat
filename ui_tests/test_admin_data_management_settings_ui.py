...
Version 0.250.075 adds migration provenance, retry, concurrency, access validation,
and temporary destination Cosmos capacity controls.
Version 0.250.076 adds cooperative cancellation and automatic stale migration recovery.
Version 0.250.077 adds incremental modes, destructive mirror confirmation,
live inventory preview, and preview-versus-actual reconciliation.
Version 0.250.078 adds the external target Search writer freeze acknowledgement.
"""
