...
_ADMIN_RELEASE_260_FEATURE_CATALOG = [
    ...
    _latest_feature_card(
        ...
        actions=[
            {'label': 'Open Scale', 'description': 'Review Document Access Index health, fallbacks, RU, and latency.', 'href': '#scale', 'admin_tab': '#scale', 'icon': 'bi-lightning-charge'},
        ],
    ...
    _latest_feature_card(
        ...
        actions=[
            {'label': 'Open Scale', 'description': 'Run Cosmos maintenance and configure throughput guardrails.', 'href': '#scale', 'admin_tab': '#scale', 'icon': 'bi-database-gear'},
        ],
