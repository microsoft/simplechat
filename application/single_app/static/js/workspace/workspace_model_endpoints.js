...
function updateAuthVisibility() {
    ...
    setElementVisibility(endpointOpenAiApiVersionGroup, !customProvider || apiType === "azure_openai");
    setElementVisibility(endpointAnthropicVersionGroup, customProvider && apiType === "anthropic");
