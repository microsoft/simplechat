...
resource openAiService 'Microsoft.CognitiveServices/accounts@2024-10-01' existing = if (openAIName != '') {
  name: openAIName
}
...
resource openAIUserRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (openAIName != '') {
...
resource docIntelUserRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (docIntelName != '') {
...
resource speechServiceUserRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = if (speechServiceName != '') {
