...
@description('''The dev/qa/prod environment or as named in your environment. Default is "dev". This will be used to create resource group names and tags.
...
param useExistingOpenAISvc bool = false
...
var containerImageName = '${acrName}${acrCloudSuffix}/${imageName}'
...
module acr_existing 'modules/azureContainerRegistry-existing.bicep' = if (useExistingAcr) {
  name: 'azureContainerRegistry_existing'
