...
4.  **Deploy Azure AI Search**:
    ...
    *   If using **Managed Identity**, grant the App Service's Managed Identity the `Contributor` role on this resource.
...
2. **Assign Roles to the Managed Identity**:
   ...
   **Required Roles for Managed Identity Access:**
   ...
   | Azure AI Search       | Contributor       | Allows token acquisition from Search ARM service, reading/writing data to search indexes.               |
