...
Linux and macOS users can run the AZD commands from bash, but should be invoked with `pwsh`.

```powershell
pwsh azd up 
```

You will answer questions during the deployment process for more details on those questions please review  [deployers/bicep/README.md](./deployers/bicep/README.md).
