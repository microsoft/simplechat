...
def test_debug_logging_added():
    ...
    try:
        ...
        debug_patterns = [
            'debug_print(f"DEBUG: Enhanced citations PDF request',
            'debug_print(f"DEBUG: serve_enhanced_citation_pdf_content',
            'debug_print(f"DEBUG: Setting CSP headers for iframe embedding',
            'debug_print(f"DEBUG: serve_workflow_pdf_content',
        ]
