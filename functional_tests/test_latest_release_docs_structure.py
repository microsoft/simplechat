...
Version: 0.250.046
Implemented in: 0.241.002; 0.241.003; 0.241.164; 0.241.165; 0.241.166; 0.241.167; 0.241.183; 0.241.184; 0.250.001; 0.250.034; 0.250.035; 0.250.036; 0.250.041; 0.250.042; 0.250.043; 0.250.044; 0.250.045; 0.250.046
...
def test_latest_release_docs_structure() -> bool:
    ...
    assert 'VERSION = "0.250.046"' in config_content, "Config version marker is not current."
