...
Member roles defined in the pure workflow policy module: 0.261.174
...
def test_group_workflow_feature_contracts():
    ...
    checks = [
        ...
        _assert_contains(workflow_routes, "@bp.route('/api/group/workflows'", "group workflow list/save route"),
        _assert_contains(workflow_routes, "@bp.route('/api/group/workflows/agents'", "group workflow agents route"),
        _assert_contains(workflow_routes, "@bp.route('/api/group/workflows/file-sync-sources'", "group workflow File Sync route"),
        _assert_contains(workflow_routes, "@bp.route('/api/group/workflows/activity'", "group workflow activity route"),
